...
This repository is created in connection to the International Virtual Innovation Challenge at Hochschule München for the spring semester 2021. 
...
ECOskiers is the app making it easier for winter sport enthusiasts to make sustainable choices. As a skiier you do not have to get out of your comfortzone nor sacrifaice convenience in order to act more environmentally friendly. Actually, you do not have to change your behavior significantly other that choosing a better ski resort. This will also give the ski resorts incentives to improve their facilities and policies to take better care of the nature. 
ECOskiers lets you have a quick and easy overview of different ski resorts and evaluates them based on different sustainablility factors such as: water usage, energy consumption and use of snow canons. These ratings come from a collaboration with the ski resorts, which answer questionnarires that gives ECOskiers information on their facilities and policies regarding environmental measures. This is then evaluated by expertes and put into the app.
The purpose of the app is not only to show which ski resorts are better, you can also book your ski resort directly through ECOskiers. Besides the sustainabbility rating you can also see information such as weather conditions, address, contact details and kilometers of slopes. The real advantage for the user comes through booking the package deals, which are all different, but could contain accomodation, transportation and ski pass all in one. 
